...
To run the app, spin up an HTTP server (e.g. `python -m SimpleHTTPServer` or `npm install -g httpserver; httpserver`) and visit [http://localhost:8080/index.html](http://localhost:8080/index.html) .
